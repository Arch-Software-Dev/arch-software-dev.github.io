...
const heroInformation = {
    ...
    title: "Arch Software Development co.",
    btnText: "Click Here",
}
                            ...
                            <div className="col-lg-6 col-md-6">
                                <div className="slider-content s-slider-content">
                                    ...
                                    <div className="slider-btn">
                                        <Link to="https://docs.google.com/forms/d/e/1FAIpQLScHiVaf7WHQVXEk-arCjFqxGP4LJOAqKU-PqCRpZZUBCoSVbA/viewform" className="btn ss-btn mr-15">
                                            {btnText}
                                        </Link>
                                    </div>
                                </div>
